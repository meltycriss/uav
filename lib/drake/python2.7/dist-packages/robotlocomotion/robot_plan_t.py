...
class robot_plan_t(object):
    __slots__ = ["utime", "robot_name", "num_states", "plan", "plan_info", "num_grasp_transitions", "grasps", "left_arm_control_type", "right_arm_control_type", "left_leg_control_type", "right_leg_control_type", "num_bytes", "matlab_data"]
    ...
    def __init__(self):
        ...
        self.grasps = []
        self.left_arm_control_type = 0
        self.right_arm_control_type = 0
        self.left_leg_control_type = 0
        self.right_leg_control_type = 0
        self.num_bytes = 0
        self.matlab_data = ""

    def encode(self):
        buf = BytesIO()
        buf.write(robot_plan_t._get_packed_fingerprint())
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">bbbbi", self.left_arm_control_type, self.right_arm_control_type, self.left_leg_control_type, self.right_leg_control_type, self.num_bytes))
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != robot_plan_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return robot_plan_t._decode_one(buf)
    ...
    def _decode_one(buf):
        ...
        self.left_arm_control_type, self.right_arm_control_type, self.left_leg_control_type, self.right_leg_control_type, self.num_bytes = struct.unpack(">bbbbi", buf.read(8))
    ...
    def _get_hash_recursive(parents):
        if robot_plan_t in parents: return 0
        newparents = parents + [robot_plan_t]
        tmphash = (0x78a77f5ef28fedee+ bot_core.robot_state_t._get_hash_recursive(newparents)+ robotlocomotion.grasp_transition_state_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if robot_plan_t._packed_fingerprint is None:
            robot_plan_t._packed_fingerprint = struct.pack(">Q", robot_plan_t._get_hash_recursive([]))
        return robot_plan_t._packed_fingerprint
