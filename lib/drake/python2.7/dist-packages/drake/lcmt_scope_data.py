...
class lcmt_scope_data(object):
    ...
    def _decode_one(buf):
        ...
        self.linespec = buf.read(__linespec_len)[:-1].decode('utf-8', 'replace')
        self.resetOnXval = bool(struct.unpack('b', buf.read(1))[0])
        self.xdata, self.ydata = struct.unpack(">dd", buf.read(16))
        return self
