...
int lcmt_scope_data::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    char* linespec_cstr = const_cast<char*>(this->linespec.c_str());
...
uint64_t lcmt_scope_data::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xce3bf247025afc2fLL;
