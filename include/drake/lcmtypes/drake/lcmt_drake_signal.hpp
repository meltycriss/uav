...
int lcmt_drake_signal::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    for (int a0 = 0; a0 < this->dim; a0++) {
        char* __cstr = const_cast<char*>(this->coord[a0].c_str());
...
uint64_t lcmt_drake_signal::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x236e73ecd6fc3932LL;
