...
#ifndef __robotlocomotion_robot_plan_w_keyframes_t_hpp__
#define __robotlocomotion_robot_plan_w_keyframes_t_hpp__
...
class robot_plan_w_keyframes_t
{
    public:
        int64_t    utime;
        ...
        std::vector< int8_t > is_keyframe;

        std::vector< int8_t > is_breakpoint;
    ...
    public:
        ...
        /**
         * Returns "robot_plan_w_keyframes_t"
         */
...
int robot_plan_w_keyframes_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int robot_plan_w_keyframes_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int robot_plan_w_keyframes_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t robot_plan_w_keyframes_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* robot_plan_w_keyframes_t::getTypeName()
{
    return "robot_plan_w_keyframes_t";
}

int robot_plan_w_keyframes_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->num_keyframes, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->num_breakpoints, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    if(this->num_states > 0) {
        tlen = __boolean_encode_array(buf, offset + pos, maxlen - pos, &this->is_keyframe[0], this->num_states);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    if(this->num_states > 0) {
        tlen = __boolean_encode_array(buf, offset + pos, maxlen - pos, &this->is_breakpoint[0], this->num_states);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int robot_plan_w_keyframes_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->num_keyframes, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->num_breakpoints, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    if(this->num_states) {
        this->is_keyframe.resize(this->num_states);
        tlen = __boolean_decode_array(buf, offset + pos, maxlen - pos, &this->is_keyframe[0], this->num_states);
        if(tlen < 0) return tlen; else pos += tlen;
    }

    if(this->num_states) {
        this->is_breakpoint.resize(this->num_states);
        tlen = __boolean_decode_array(buf, offset + pos, maxlen - pos, &this->is_breakpoint[0], this->num_states);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int robot_plan_w_keyframes_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
    ...
    enc_size += __int32_t_encoded_array_size(NULL, 1);
    enc_size += __int32_t_encoded_array_size(NULL, 1);
    enc_size += __boolean_encoded_array_size(NULL, this->num_states);
    enc_size += __boolean_encoded_array_size(NULL, this->num_states);
    for (int a0 = 0; a0 < this->num_states; a0++) {
...
uint64_t robot_plan_w_keyframes_t::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == robot_plan_w_keyframes_t::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)robot_plan_w_keyframes_t::getHash };

    uint64_t hash = 0xf27c84dcdd3fbfd0LL +
