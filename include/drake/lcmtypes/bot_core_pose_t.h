...
/**
 * note that this message is defined in body coordinates.
 * all velocity and accel values ARE IN BODY COORDINATES!
 */
...
/**
 * Create a deep copy of a bot_core_pose_t.
 * When no longer needed, destroy it with bot_core_pose_t_destroy()
 */
bot_core_pose_t* bot_core_pose_t_copy(const bot_core_pose_t* to_copy);

/**
 * Destroy an instance of bot_core_pose_t created by bot_core_pose_t_copy()
 */
void bot_core_pose_t_destroy(bot_core_pose_t* to_destroy);
 ...
 * bot_core_pose_t is received.
 */
typedef void(*bot_core_pose_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const bot_core_pose_t *msg, void *userdata);

/**
 * Publish a message of type bot_core_pose_t using LCM.
 *
 ...
 */
int bot_core_pose_t_publish(lcm_t *lcm, const char *channel, const bot_core_pose_t *msg);

/**
 * Subscribe to messages of type bot_core_pose_t using LCM.
 *
 ...
 */
bot_core_pose_t_subscription_t* bot_core_pose_t_subscribe(lcm_t *lcm, const char *channel, bot_core_pose_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by bot_core_pose_t_subscribe()
 */
...
/**
 * Encode a message of type bot_core_pose_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to bot_core_pose_t_encoded_size().
...
/**
 * Decode a message of type bot_core_pose_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with bot_core_pose_t_decode_cleanup().
 *
 ...
 */
int bot_core_pose_t_decode(const void *buf, int offset, int maxlen, bot_core_pose_t *msg);

/**
 * Release resources allocated by bot_core_pose_t_decode()
 * @return 0
 */
int bot_core_pose_t_decode_cleanup(bot_core_pose_t *p);

/**
 * Check how many bytes are required to encode a message of type bot_core_pose_t
 */
int bot_core_pose_t_encoded_size(const bot_core_pose_t *p);

// LCM support functions. Users should not call these
int64_t __bot_core_pose_t_get_hash(void);
uint64_t __bot_core_pose_t_hash_recursive(const __lcm_hash_ptr *p);
