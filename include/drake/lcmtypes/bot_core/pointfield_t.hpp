...
#ifndef __bot_core_pointfield_t_hpp__
#define __bot_core_pointfield_t_hpp__
...
int pointfield_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int pointfield_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int pointfield_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t pointfield_t::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* pointfield_t::getTypeName()
{
    return "pointfield_t";
}

int pointfield_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int pointfield_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int pointfield_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t pointfield_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xd92708412f05a3b6LL;
