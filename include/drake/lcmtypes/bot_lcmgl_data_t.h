...
/**
 * Create a deep copy of a bot_lcmgl_data_t.
 * When no longer needed, destroy it with bot_lcmgl_data_t_destroy()
 */
bot_lcmgl_data_t* bot_lcmgl_data_t_copy(const bot_lcmgl_data_t* to_copy);

/**
 * Destroy an instance of bot_lcmgl_data_t created by bot_lcmgl_data_t_copy()
 */
void bot_lcmgl_data_t_destroy(bot_lcmgl_data_t* to_destroy);
 ...
 * bot_lcmgl_data_t is received.
 */
typedef void(*bot_lcmgl_data_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const bot_lcmgl_data_t *msg, void *userdata);

/**
 * Publish a message of type bot_lcmgl_data_t using LCM.
 *
 ...
 */
int bot_lcmgl_data_t_publish(lcm_t *lcm, const char *channel, const bot_lcmgl_data_t *msg);

/**
 * Subscribe to messages of type bot_lcmgl_data_t using LCM.
 *
 ...
 */
bot_lcmgl_data_t_subscription_t* bot_lcmgl_data_t_subscribe(lcm_t *lcm, const char *channel, bot_lcmgl_data_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by bot_lcmgl_data_t_subscribe()
 */
...
/**
 * Encode a message of type bot_lcmgl_data_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to bot_lcmgl_data_t_encoded_size().
...
/**
 * Decode a message of type bot_lcmgl_data_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with bot_lcmgl_data_t_decode_cleanup().
 *
 ...
 */
int bot_lcmgl_data_t_decode(const void *buf, int offset, int maxlen, bot_lcmgl_data_t *msg);

/**
 * Release resources allocated by bot_lcmgl_data_t_decode()
 * @return 0
 */
int bot_lcmgl_data_t_decode_cleanup(bot_lcmgl_data_t *p);

/**
 * Check how many bytes are required to encode a message of type bot_lcmgl_data_t
 */
int bot_lcmgl_data_t_encoded_size(const bot_lcmgl_data_t *p);

// LCM support functions. Users should not call these
int64_t __bot_lcmgl_data_t_get_hash(void);
uint64_t __bot_lcmgl_data_t_hash_recursive(const __lcm_hash_ptr *p);
